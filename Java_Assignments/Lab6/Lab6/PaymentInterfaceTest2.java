 ...
 *
 *  This is the main class where we test our payme interface by using the default method display() to print each
 *  instance.
 * @author afnan
 * @version 6.1
 ...
 */
//PART----B----
public class PaymentInterfaceTest2 {
	/**
